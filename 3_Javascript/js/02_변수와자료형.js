...
// 이전에 선언해놓은 변수값을 쓸 수 없게 되는 문제가 발생함.
...
// const test; 에러 || 상수는 선언과 동시에 초기화 반드시 !!
...
// var 키워드로 선언된 변수는
// 함수 내 어디서든 접근할 수 있음.
// if, for 등의 일반블록은 무시하고, var 로 선언된 변수가 있는
// 함수 전체에서 유효함.
...
console.log(test2);
// -> test2 도 출력 가능.
// -> 왜? 함수레벨 스코프인 var는 일반블록은 무시하기 때문
...
// 최상단으로 호이스팅됨.
// var와 달리, let / const 로 선언된 변수는 초기화가
// 이루어지기 전에는 사용될 수 없음.
...
// 이 기간동안 변수에 접근하려고 하면
// Cannot access 'x' before initialization 라는 에러가 발생.
...
// JS 자료형 확인하기
// typeof 연산자 : 변수 / 값 의 자료형을 출력하는 연산자
